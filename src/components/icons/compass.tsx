...
export const Compass = () => (
  ...
  >
    <rect width="24" height="24" fill="url(#patternCompass)" />
    <defs>
      <pattern
        id="patternCompass"
